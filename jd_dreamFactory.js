...
async function joinLeaderTuan() {
  let res = await updateTuanIdsCDN('https://cdn.jsdelivr.net/gh/6dylan6/11111128@main/shareCodes/11111127')
  if (!res) {
    $.http.get({url: 'https://purge.jsdelivr.net/gh/6dylan6/11111128@main/shareCodes/11111127'}).then((resp) => {}).catch((e) => $.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await updateTuanIdsCDN('https://cdn.jsdelivr.net/gh/6dylan6/11111128@main/shareCodes/11111127');
  }
...
function readShareCode() {
  console.log(`开始`)
  return new Promise(async resolve => {
    $.get({url: `https://cdn.jsdelivr.net/gh/6dylan6/11111128@main/shareCodes/jxfactory.json`, timeout: 10000}, (err, resp, data) => {
      try {
        if (err) {
          console.log(JSON.stringify(err))
          console.log(`${$.name} API请求失败，请检查网路重试`)
