...
let appIdArr = ["1EFRQwA", "1GVFUx6g", "1E1xZy6s","1EFRXxg","1EFRWxKuG","1FFVQyqw"];
let appNameArr = ["疯狂砸金蛋","JOY年味之旅","PLUS生活特权","1","2","3"];
let appId, appName;
$.shareCode = [];
if ($.isNode()) {
...
!(async () => {
  ...
  let res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/6dylan6/11111128@main/shareCodes/11111127')
  if (!res) {
    $.http.get({url: 'https://cdn.jsdelivr.net/gh/6dylan6/11111128@main/shareCodes/11111127'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/6dylan6/11111128@main/shareCodes/11111127')
  }
