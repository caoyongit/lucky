...
!(async () => {
  ...
  if (process.env.PIGPETSHARECODE) {
    ...
    let res = await getAuthorShareCode('https://raw.githubusercontent.com/888888/11111128/main/shareCodes/pigPet.json')
    if (!res) {
      res = await getAuthorShareCode('https://raw.fastgit.org/888888/11111128/main/shareCodes/pigPet.json')
    }
    if (res){
  ...
  console.log(`\n======开始大转盘助力======\n`);
  $.helpId = await getAuthorShareCode('https://raw.fastgit.org/888888/11111128/main/shareCodes/pig.json');
